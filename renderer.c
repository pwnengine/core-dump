...
const SDL_Rect drag_area = {0, 0, 300, 25};
...
void r_init(void) {
    /* init SDL window */
    window = SDL_CreateWindow("Evility: For Rust 2022", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, width, height, SDL_WINDOW_ALLOW_HIGHDPI | SDL_WINDOW_BORDERLESS);
...
void r_draw_icon(int id, mu_Rect rect, mu_Color color) {
    ...
    SDL_Surface* img_surface = IMG_Load("checkmark.png");
